                ...
                children: [
                  Stack(
                    ...
                    children: [
                      _buildProductImagesCarousel(
                          context, [controller.product.value.image], ""),
                      CustomAppBar(
                        myFunction: () {},
                        title: "Product",
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        //Description
                        _buildProductDetails(context, controller.product.value),

                        //Product rating
                        _buildProductRating(),
                        //Product Reviews
                        _buildProductReviews(context, controller.product.value),
...
//                           _buildProductColors(context),
      ...
      floatingActionButton: buildFloatingButton(
          buttonName: 'Add to Cart', context: context, onPressed: () {}),
      // SizedBox(
      //   height: 90.h,
  ...
  _buildProductImagesCarousel(
      BuildContext context, List<String> imgList, placeHolderImg) {
    //adding attachments
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              "Reviews (${controller.product.value.ratings_count.toString()})",
                              style: secondaryTextStyle(

                                    ...
                                    Obx(() {
                                      return
                                        isProductInCart(product, myCartController) &&
                                            userToken != null
                                            ?
                                        buildShowAddToCartButton(context, product, myCartController)
...
buildShowAddToCartButton(context, Product product, myCartController) {
  return Stack(
    alignment: Alignment.center,
    children: [
      Transform.translate(
...
void handleIncrement(Product product, myCartController) {
  if (userToken == null) {
    Get.to(() => LoginView());
  } else {
    int initialQty = product.d_limit > 0
...
void handleDecrement(Product product , myCartController) {
  if (userToken == null) {
    Get.to(() => LoginView());
    return;
  }

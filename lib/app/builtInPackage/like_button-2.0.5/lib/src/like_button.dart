...
import '../src/painter/bubbles_painter.dart';
import '../src/painter/circle_painter.dart';
import '../src/utils/like_button_model.dart';
import '../src/utils/like_button_typedef.dart';
import '../src/utils/like_button_util.dart';
...
class LikeButtonState extends State<LikeButton> with TickerProviderStateMixin {
  ...
  void _handleIsLikeChanged(bool? isLike, dynamic object) {
    if (_isLiked == null) {
      if (_likeCount != null) {
        _preLikeCount = _likeCount;
